...
const Info = ({ limit }) => {
    const items = [
        ...
        { img: info6, title: 'Порядок подачи судебного приказа', link: '/court-order' , desc:' Судебный приказ – быстрый способ взыскать алименты. Узнайте, как его оформить и подать в суд.'},
