      ...
      <section className='container'>
        <div className='flex flex-col md:flex-row items-center justify-center gap-8'>
          ...
          <div className="p-6 max-w-sm shadow-md rounded-2xl bg-[#FFFFFF82]">
            {/* Выбор региона */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Выберите регион</label>
              <select
                value={region}
            ...
            {/* Количество детей */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Количество детей</label>
              <input
                type="number"
                value={childrenCount}
            ...
            {/* Зарплата */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Зарплата в сомах</label>
              <input
                type="text"
                value={salary}
                readOnly
